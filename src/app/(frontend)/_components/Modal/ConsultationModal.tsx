    ...
    <div className="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-custom p-6 w-full max-w-md text-center relative mx-6 shadow-2xl">
        <div className="flex justify-end items-end mb-4">
          <X onClick={onClose} size={28} className="cursor-pointer text-black" />
        </div>
          ...
          <div>
            {formState.success ? (
              ...
              <div className="flex flex-col gap-6 md:p-4">
                <span className="text-xl leadForm text-center text-black">
                ...
                <FormBuilder
                  ...
                  classNames={{
                    ...
                    input:
                      'peer w-full rounded-2xl px-4 pt-5 pb-2 text-black bg-[#F3F4F4] text-lg focus:outline-none focus:ring-2',
                    button:
